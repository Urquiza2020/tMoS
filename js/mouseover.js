function desPlacaje()
{
						document.getElementById("Eldano").innerHTML="Da\361o :";  // para cambiar la etiqueta de daño
...
var algo=document.getElementById("bntAtaque");  //cuando se pasa el puntero por arriba ataque 1 , no se sale   ///////////////////////////////////////////////////////////////
			...
			var algo=document.getElementById("bntAtk3");  //cuando se pasa el puntero por arriba ataque 3 , no se sale   
					algo.onmouseover=function()
					{
						ataque3();
					};
			var algo=document.getElementById("bntAtk2");  //cuando se pasa el puntero por arriba ataque 2 , no se sale   
					algo.onmouseover=function()
					{
						ataque2();
					};
			var algo=document.getElementById("bntAtk4");  //cuando se pasa el puntero por arriba ataque 4 , no se sale  
					algo.onmouseover=function()
					{
						ataque4();
					};
			var algo=document.getElementById("Spritebtn2");  //cuando se pasa el puntero por arriba ataque 4 , no se sale  
					algo.onmouseover=function()
					{
						ataque2();
					};
			var algo=document.getElementById("Spritebtn3");  //cuando se pasa el puntero por arriba ataque 3 , no se sale   
					algo.onmouseover=function()
					{
						ataque3();
					};
			var algo=document.getElementById("Spritebtn4");  //cuando se pasa el puntero por arriba ataque 4 , no se sale  
					algo.onmouseover=function()
					{
...
var algo=document.getElementById("numero1");  //cuando se pasa el puntero por arriba ataque 2 , no se sale   
					algo.onmouseover=function()
					{
						ataque2();
					};
var algo=document.getElementById("numero2");  //cuando se pasa el puntero por arriba ataque 3 , no se sale   
					algo.onmouseover=function()
					{
						ataque3();
					};
var algo=document.getElementById("numero3");  //cuando se pasa el puntero por arriba ataque 4 , no se sale  
					algo.onmouseover=function()
					{
					ataque4();
					};
