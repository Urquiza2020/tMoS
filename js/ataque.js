...
function ataque(atk) 
			{
				...
				if(atk==1) //Ataque 2 Placaje
				{
					...
					document.getElementById("manapj").innerHTML="Maná: "+mana;
				...
				var timout=setTimeout(function(){   //esto es para que tarde en atacar el NPC    
						...
						//{ 
							...
							{
								document.getElementById("manapj").innerHTML="Mana:"+mana;
								document.getElementById("gra3").style.width=porcenBarraMP(manaTotal,danoNPC,"0")+"%"; //que baje la barra mana si esta puesto el magic shield
							}
						//}
